...
@Entity(tableName = "defect_image", foreignKeys = [
    (ForeignKey(entity = DefectInfoEntity::class,
                parentColumns = ["id"],
                childColumns = ["defect_info_id"],
                onDelete = ForeignKey.CASCADE))],
        indices = [(Index(value = ["defect_info_id"], name = "defect_image_defect_info_idx"))])
data class DefectImageEntity(@PrimaryKey(autoGenerate = true) val id: Long,
