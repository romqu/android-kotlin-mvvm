...
@Entity(tableName = "street_address", foreignKeys = [
    (ForeignKey(entity = DefectListEntity::class,
        ...
        indices = [(Index(value = ["defect_list_id"], name = "street_address_defect_list_idx"))])
data class StreetAddressEntity @JvmOverloads constructor(@PrimaryKey(autoGenerate = true) val id: Long,
                                                         ...
                                                         @Ignore val floorEntityList: List<FloorEntity> = emptyList(),
                                                         @Ignore val viewParticipantEntityList: List<ViewParticipantEntity> = emptyList())