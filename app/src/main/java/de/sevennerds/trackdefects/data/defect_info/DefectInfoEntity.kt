...
@Entity(tableName = "defect_info", foreignKeys = [
    (ForeignKey(entity = RoomEntity::class,
        ...
        indices = [(Index(value = ["room_id"], name = "defect_info_room_idx"))])
data class DefectInfoEntity @JvmOverloads constructor(@PrimaryKey(autoGenerate = true) val id: Long,
                                                      ...
                                                      @Ignore val defectImageEntityList: List<DefectImageEntity> = emptyList())