...
data class DefectListEntity constructor(
        @PrimaryKey(autoGenerate = true) @ColumnInfo(name = "id") val id: Long,
        @ColumnInfo(name = "remote_id") val remoteId: Long,
        @ColumnInfo(name = "name") val name: String,
        @ColumnInfo(name = "creation_date") val creationDate: String,
        @Ignore @ColumnInfo(name = "floor_plan_id") val floorPlanEntity: FloorPlanEntity,
        @Ignore @ColumnInfo(name = "street_address_id") val streetAddressEntity: StreetAddressEntity,
        @Ignore @ColumnInfo(name = "view_participant_id") val viewParticipantEntity: ViewParticipantEntity
)
